...
_ALIASES = {
    ...
    "пилешки гърди": "chicken", "chicken breast": "chicken", "chicken breast roasted": "chicken",
    "ориз": "rice", "ориз сварен": "rice", "ориз сух": "rice", "rice cooked": "rice", "brown rice": "rice", "brown rice cooked": "rice",
    ...
    "boiled whole egg": "eggs", "сьомга": "salmon", "salmon grilled": "salmon",
    ...
    "broccoli": "broccoli", "broccoli steamed": "broccoli", "броколи": "broccoli",
    "спанак": "spinach", "spinach raw": "spinach", "quinoa cooked": "quinoa", "банан": "banana", "ябълка": "apple",
