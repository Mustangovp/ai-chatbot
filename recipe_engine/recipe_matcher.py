...
_ALIASES = {
    ...
    "ориз": "rice", "rice cooked": "rice", "овес": "oats", "овесени ядки": "oats",
    "яйце": "eggs", "яйца": "eggs", "яйчен": "eggs", "сьомга": "salmon",
    "риба тон": "tuna", "тон": "tuna", "кисело мляко": "greek_yogurt",
    "гръцко кисело мляко": "greek_yogurt", "извара": "cottage_cheese",
    "картофи": "potatoes", "картоф": "potatoes", "броколи": "broccoli",
    "спанак": "spinach", "банан": "banana", "ябълка": "apple",
    "леща": "lentils", "нахут": "chickpeas", "кайма": "lean_beef",
    "телешко": "lean_beef", "пуешко": "turkey", "хляб": "wholegrain_bread",
    "паста": "pasta", "авокадо": "avocado", "сирене": "cheese",
